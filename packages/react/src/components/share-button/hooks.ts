 ...
 */
export const download = (opts: UseDownloadOptions) => {
  let asBlob

  if (typeof opts.data == "string") {
    asBlob = new Blob([opts.data], opts.type ? { type: opts.type } : undefined)
  } else {
    asBlob = opts.data
  }
...
export const shareURL = (
  url: string,
  title?: string | null,
): Promise<"shared" | "copied"> | undefined => {
